...
namespace NeuralNetworkPlugin
{
    ...
    public class ArtificiaNeuralNetwork
    {
        ...
        {
            StreamWriter Writer = new StreamWriter(Directory.GetCurrentDirectory() + $"/SaveNeuralNetwork.json");
        ...
        {
            string Text;
            StreamReader Reader = new StreamReader(Directory.GetCurrentDirectory() + $"/SaveNeuralNetwork.json");
        ...
        {
            return UnityEngine.JsonUtility.FromJson<MultilayerPerceptron>(GetNeuralNetwork());
        }
